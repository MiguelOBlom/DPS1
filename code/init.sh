...
./make_sbt_file_structure.sh /var/scratch/$(whoami)/ graphx_connected_components_twitter_2010_map &
...
(cp ./code/gx_cc_tw_map.scala /var/scratch/$(whoami)/graphx_connected_components_twitter_2010_map/src/main/scala/main.scala
(cd /var/scratch/$(whoami)/graphx_connected_components_twitter_2010_map; sbt clean package))
